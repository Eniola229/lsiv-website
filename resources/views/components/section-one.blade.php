      <section class="flex flex-col items-center bg-miscellanous py-16">
       <div class="text-center w-full h-auto sm:h-52 md:text-6xl lg:h-auto md:p-0 p-4">
          ...
          <h2
            class="text-3xl md:text-[60px] lg:text-[40px] xl:text-[60px] font-medium md:mb-12 mb-4 font-playfair"
          >
            We drive change
          </h2>
          <p class="md:text-[24px] text-[16px] lg:text-lg xl:text-[24px] font-[400] md:mb-0 mb-4 font-medium font-opensans"> 
