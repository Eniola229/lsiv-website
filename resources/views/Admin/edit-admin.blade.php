    ...
    <div class="col-lg-6 col-md-8 mb-md-0 mb-4 ">
        <div class="card border">
            <div class="container mt-5">
                ...
                @if ($errors->any())
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative alert-danger" role="alert">
                ...
                <form action="{{ route('admin.postRegistration', $admin->id) }}" method="POST" class="mt-4">
                    @csrf
                    @method('POST') <!-- Use POST for both create and update -->
                    
                    <div class="mb-3">
                        <label for="name" class="form-label">Name</label>
                        <input type="text" class="form-control border" id="name" name="name" value="{{ old('name', $admin->name) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control border" id="email" name="email" value="{{ old('email', $admin->email) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control border" id="password" name="password" placeholder="Leave blank to keep current password">
                    </div>

                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary" style="background: darkorange;">Update Admin</button>
                    </div>
                </form>
            </div>
        </div>
