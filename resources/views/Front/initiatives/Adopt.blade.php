  ...
  <body class="bg-accentTextLight">
   @include('components.header')
    ...
    <section class="md:p-6 p-2 rounded md:mt-0 mt-[-10px]">
      ...
      <div class="overflow-hidden w-full mt-4  lg:ml-[4.5rem] ">
            <div
...
<span class="hidden md:inline">Next &rarr;</span>
     ...
     <div class="lg:max-w-4xl  max-w-7xl xl:max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-6 md:p-4 p-1 md:mt-[-30px] mt-[-40px]">
          <!-- Our Approach List -->
       <h2
       class="md:text-[48px] xl:text-[48px] lg:text-[34px]  mb-8 leading-[42.66px] text-[32px] md:mb-6 m-2 font-playfair font-[500] md:leading-[63.98px] md:p-2"       style="line-height: normal;">
            Our Approach
                       ...
                       <ul class="custom-bullet-list space-y-4 md:pl-5 font-opensans" style="line-height: 31px">
             <li class="flex items-start gap-2 mb-4 text-base md:text-[20px] md:leading-[31px] leading-[25px] font-opensans" style="line-height: 31px">
       ...
       class="md:text-[48px] xl:text-[48px] lg:text-[34px]  mb-8 leading-[42.66px] text-[32px] md:mb-6 m-2 font-playfair font-[500] md:leading-[63.98px] md:p-2"  
          style="line-height: normal;">
            ...
            <ul class="custom-bullet-list space-y-4 md:pl-5 font-opensans" style="line-height: normal;">
             <li class="flex items-start gap-2 mb-4 text-base md:text-[20px] md:leading-[31px] leading-[25px]">
                <span class="flex-shrink-0 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    <circle cx="9" cy="9" r="7" fill="#F8F8FF" stroke="#E76A35" stroke-width="4" />
                  </svg>
