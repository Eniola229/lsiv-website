   ...
   @include('components.header')
    <main>
     ...
     <section class="md:p-6 p-2 rounded md:mt-0 mt-[50px]">
        <div class="mx-auto lg:max-w-4xl xl:max-w-7xl max-w-7xl px-4 sm:px-6 lg:px-6 md:mt-0 mt-[-50px]">
            <div class="flex gap-3 items-center mb-2 text-[16px] font-[400]">
              <a href="{{ url('Initiatives-Initiatives') }}" class="flex items-center gap-1 font-opensans font-[400] text-[16px]" style="line-height: normal; letter-spacing: -0.32px;">
               ...
               <p class="text-primary font-[500] font-[16px] font-opensans" style="line-height: normal; letter-spacing: -0.32px;">The Conversation</p>
            </div>
          ...
          <div class="lg:w-2/3 lg:pl-10 ml-auto">
              <p
              class="text-accentTextDark md:mb-6 mb-0 md:text-[20px] lg:text-lg xl:text-[20px] md:leading-[31px] leading-[25px] text-[16px] font-opensans font-[400]"      
      ...
      <div class="xl:max-w-[90rem] mx-auto lg:max-w-4xl  max-w-7xl px-4 sm:px-6 lg:px-6 md:p-4 p-1 md:mt-[-30px] mt-[-40px]">
       ...
       class="md:text-[48px] xl:text-[48px] lg:text-[34px]  mb-8 leading-[42.66px] text-[32px] md:mb-6 m-2 font-playfair font-[500] md:leading-[63.98px] md:p-2" 
          ...
          <ul class="custom-bullet-list space-y-4 md:pl-5 font-opensans">
              <li class="flex items-start gap-2 mb-4 t font-opensans text-base md:leading-[31px] leading-[25px] md:text-[20px]" style="line-height: normal;">
  ...
  <section class="flex flex-col items-center bg-miscellanous py-16">
       <div class="text-center w-full h-auto sm:h-52 md:text-6xl lg:h-auto md:p-0 p-4">
          ...
          Join us in fostering <br> impactful conversations.
           ...
           <p class="md:text-[24px] xl:text-[24px] lg:text-lg text-[16px] font-[400] mb-4 font-medium font-opensans" style="line-height: normal;"> 
