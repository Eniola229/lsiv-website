    ...
    <main>
      ...
      <section class="py-4 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 mb:mt-0 mt-[-30px]">
          <h1
            class="lg:text-7xl text-5xl font-normal font-playfair text-gray-900 text-left md:text-left md:mt-12 mt-12 mb-0 md:mb-4"
        ...
        <div class="flex flex-col lg:flex-row justify-between gap-2 py-16">
          ...
          <div class="lg:w-1/3 text-xl md:sticky top-10 self-start">
            ...
            <div class="lg:w-2/3 lg:pl-10">
              ...
              <div>
                <h2
                  class="md:text-5xl text-3xl mb-6 font-playfair font-normal leading-normal" style="line-height: normal;"
                >
                  Awards & Recognition
                </h2>
      ...
      <section class="bg-[#ECECD5] py-4 rounded">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 mb:mt-0">
            ...
            <div class="lg:w-2/3 lg:pl-10">
                ...
                Transformative Leadership & Advocacy
                 ...
                 <div class="lg:hidden lg:w-1/3 text-xl mb-4">
                  <img
                    ...
                    alt="the founder of LSIV "
                    class="w-full h-96 rounded-[16px]"
                  />
                </div>
                <ul
             ...
             <div class="hidden sm:block lg:w-1/3 text-xl ">
              <img
                 src="{{ asset('https://res.cloudinary.com/dww7q9k1e/image/upload/v1734692554/image_xzhbw5.png') }}"
                alt="the founder of LSIV "
                class="w-full md:h-[565px] h-full rounded-[16px]"
              />
            </div>
          </div>
        </div>
