   ...
   @include('components.header')
    <main>
      ...
      <section class="py-4 rounded">
        <div class="lg:max-w-4xl xl:max-w-7xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 mb:mt-0 mt-[-30px]">
          <h1
            class="xl:text-7xl text-5xl font-normal font-playfair text-gray-900 text-left md:text-left md:mt-12 mt-12 mb-0 md:mb-4"
        ...
        <div class="flex flex-col lg:flex-row justify-between gap-2 py-16">
          ...
          <div class="lg:w-1/3 text-xl md:sticky top-10 self-start">
              <img
                ...
                class="w-full md:w-[424px] lg:object-contain xl:object-cover  object-center md:h-[565px] h-full rounded-[16px] transform -scale-x-100"
              />
            </div>

            <!-- Text Section -->
            <div class="lg:w-2/3 mt-4 lg:mt-0 lg:pl-10">
              <p
              ...
              <div>
                <h2
                  class="md:text-5xl lg:text-3xl xl:text-5xl text-3xl mb-6 font-playfair font-normal leading-normal" style="line-height: normal;"
                >
                  Awards & Recognition
                </h2>
                <p  class="text-[16px] mb-6 font-[400] leading-normal font-opensans text-[16px] md:text-[16px]" style="line-height: normal;">Lolo’s dedication to women’s rights has earned her numerous accolades, including:</p>
                <ul
                  class="custom-bullet-list space-y-4 text-accentTextDark leading-[2.1675rem] mb-6 md:text-[16px] font-opensans"
                >
                    <li class="flex gap-4 mb-2 font-[400] items-center text-[16px] md:text-[16px]" style="line-height: normal;">
                       <span class="mt-0">
      ...
      <section class="bg-[#ECECD5] py-4 rounded">
        ...
        <div class="lg:max-w-4xl xl:max-w-7xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 mb:mt-0">
          <div class="flex flex-col lg:flex-row-reverse  justify-between gap-4 py-4">
            <!-- Image Section - Desktop Only -->
            <div class="hidden lg:block lg:w-1/3 text-xl">
              <img
                src="{{ asset('https://res.cloudinary.com/dww7q9k1e/image/upload/v1734689614/condom_i2nlz9.jpg') }}"
                alt="the founder of LSIV"
            ...
            <!-- Text Section -->
            <div class="lg:w-2/3 space-y-4 lg:space-y-0">
              <div>
                <!-- Image Section - Mobile Only -->
                  <div class="block lg:hidden lg:w-1/3 text-xl mb-4">
                    <img
                      src="{{ asset('https://res.cloudinary.com/dww7q9k1e/image/upload/v1734689614/condom_i2nlz9.jpg') }}"
                      alt="the founder of LSIV"
                      class="w-full h-auto rounded-[16px]"
                ...
                <h2
                  class="md:text-[56px] lg:text-5xl xl:text-[56px] text-[32px] mb-4 md:mb-6 font-playfair font-normal leading-normal"
                style="line-height: normal;">
                ...
                >
                    <li class="flex font-[400] text-[16px] md:text-[16px] mb-12" style="line-height: 30px;">
                  ...
                  <li class="flex mb-2 font-[400] text-[16px] md:text-[16px]" style="line-height: 30px;">
      ...
      <section class="py-4 rounded">
      <div class="lg:max-w-4xl xl:max-w-7xl max-w-7xl mx-auto px-4 md:px-0 mb:mt-0">

        <!-- <div class="max-w-7xl px-4 sm:px-6 lg:px-6 mb:mt-0 "> -->
          <div class="flex flex-col lg:flex-row-reverse justify-between gap-4 py-4">
            <!-- Text Section -->
            <div class="lg:w-2/3 lg:pl-6">
              <div>
                <!-- Image mobile Section -->
                <div class="lg:hidden lg:w-1/3 text-xl mb-4">
                  <img
                  src="{{ asset('https://res.cloudinary.com/dww7q9k1e/image/upload/v1734692554/image_xzhbw5.png') }}"
                  alt=" Lolo Cynthia the founder of LSIV "
                  class="w-full h-[40rem] object-cover rounded-[16px]"
                  />
                </div>
                <h2
                  class="md:text-[56px] lg:text-5xl xl:text-[56px] text-[32px] md:mb-4 mb-4 font-playfair font-normal leading-normal"
                style="line-height: normal;">
                Transformative Leadership & Advocacy
                </h2>
                <ul
                  class="custom-bullet-list text-accentTextDark leading-[2.1675rem] mb-6  font-opensans font-[400] text-[16px] md:text-[16px]" 
                >
                    <li class="flex mb-4 font-[400] text-[16px] md:text-[16px]" style="line-height: 30px;">
                  ...
                  <li class="flex mb-3 font-[400] text-[16px] md:text-[16px]" style="line-height: 30px;">
             ...
             <div class="hidden sm:block lg:w-1/3 text-xl ">
              <img
                 src="{{ asset('https://res.cloudinary.com/dww7q9k1e/image/upload/v1734692554/image_xzhbw5.png') }}"
                alt=" Lolo Cynthia the founder of LSIV "
                class="w-full object-contain md:h-[565px] h-full rounded-[16px]"
              />
            </div>
          </div>
        </div>
      ...
      <section class="bg-miscellanous py-16 rounded">
        <div class="lg:max-w-4xl xl:max-w-7xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 mb-0 mt-[-30px]">
          <h2
            class="md:text-5xl lg:text-4xl xl:text-5xl text-[32px] mb-6 font-playfair font-[500] leading-normal"
          style="line-height: normal;">
            Her Core Values
          </h2>
          ...
          >
            ...
            >
              <h3
                class="md:text-[2rem] text-[24px] lg:text-[1.5rem] xl:text-[2rem] leading-[2.272375rem] font-[600] md:font-semibold font-opensans"
              style="line-height: normal;">
                Resilience
              </h3>
            ...
            >
              <h3
                class="md:text-[2rem] text-[24px] lg:text-[1.5rem] xl:text-[2rem] leading-[2.272375rem] font-[600] md:font-semibold"
              style="line-height: normal;">
                Integrity
              </h3>
